...
/**
 * Created by mrhyndress on 11/17/16.
 */


public class ColorRecognize {
    private final ArrayList<ColorName> colorList = new ArrayList<>(Arrays.asList(
     ...
     * @param g
     * @param b
     * @return (string) color name, or error message
     */
    ...
    private class ColorName {
         ...
         * @param pixG
         * @param pixB
         * @return (int) Marginal error of likelihood that it is this color
         */
